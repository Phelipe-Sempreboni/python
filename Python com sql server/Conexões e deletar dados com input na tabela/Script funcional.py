...
#Nota3: Caso queira testar este comando Python com o a consulta (DELETE) que foi deixada como exemplo, irei deixar abaixo do comando Python, um script para ser executado no SQL Server que irá gerar essa infos.
