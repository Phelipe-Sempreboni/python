'''
Esse scritp acessa um site de API com informações do COVID-19 e nos retorna resultados de todos os países.
...
request = requests.get("https://covid19-brazil-api.now.sh/api/report/v1/countries")
